      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium">Size: {size}x{size}px</label>
              <Input
                type="range"
                min="100"
                max="400"
      ...
      <Card>
        <CardContent className="p-4">
          <div className="text-sm text-muted-foreground space-y-1">
            <p><strong>Supported formats:</strong> URLs, text, email (mailto:), phone (tel:), WiFi credentials</p>
            <p><strong>WiFi format:</strong> WIFI:T:WPA;S:NetworkName;P:Password;;</p>
            <p><strong>Tip:</strong> QR codes are generated automatically as you type</p>
          </div>
        </CardContent>
      </Card>
    </div>
